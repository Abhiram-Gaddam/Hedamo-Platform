...
export default function Navbar({ onMenuToggle }) {
  ...
  return (
    <header
      ref={navbarRef}
      className="bg-white/90 dark:bg-dark-bg/90 border-b border-gray-200 dark:border-gray-700 px-4 sm:px-6 py-4 sticky top-0 z-50 backdrop-blur-xl"
    >
      <div className="flex items-center justify-between gap-4">
         <button
          onClick={onMenuToggle}
          className="p-3 rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all lg:hidden"
        ...
        >
         ...
         <button
          ...
          className="p-3 rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-primary/10 dark:hover:bg-primary/20 transition-all duration-200 group"
