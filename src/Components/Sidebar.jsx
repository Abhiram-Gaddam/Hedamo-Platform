...
import { Home, Package, PlusCircle, BarChart3, Menu, X } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const [isMobileOpen, setIsMobileOpen] = useState(window.innerWidth >= 1024);
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-5 left-5 z-[70] lg:hidden p-3 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 transition-all"
